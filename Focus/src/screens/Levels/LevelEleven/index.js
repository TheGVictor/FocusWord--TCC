...
export default function LevelScreenEleven() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.levelContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.textLevel}>Nível 11</Text>
        ...
        <TouchableOpacity style={styles.btStart} onPress={() => navigation.navigate("GameEleven")}>
