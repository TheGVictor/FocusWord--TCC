...
export default function LevelScreenSix() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Image
        ...
        source={require('../../../images/TelaDoCacaPalavras/bg/mathbg.png')} />

      <View style={styles.levelContainer}>
        <View style={styles.header}>
          <Image style={styles.levelIndicator}
            source={require('../../../images/tela_mapa/levelIndicator.png')} />
          <Text style={styles.textLevel}>Nível 06</Text>
        ...
        <TouchableOpacity style={styles.btStart} onPress={() => navigation.navigate("GameSix")}>
