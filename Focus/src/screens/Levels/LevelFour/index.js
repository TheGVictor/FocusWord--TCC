...
export default function LevelScreenFour() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.levelContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.textLevel}>Nível 04</Text>
        ...
        <TouchableOpacity style={styles.btStart} onPress={() => navigation.navigate("GameFour")}>
